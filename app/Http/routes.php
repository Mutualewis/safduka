...
Route::group(['middleware' => ['auth', 'countrysession']], function()
	{
		...
		Route::get('/cataloguequalitydetails2', 'QualityController@qualityForm2'); 
		Route::post('/cataloguequalitydetails2', 'QualityController@addQualityDetails2');
		...
		Route::get('/cleanresuls/addBatch/{ref_no}/{warehouse}/{weigh_scales}/{zone}/{packaging}/{packages_batch}/{batch_kilograms}/{pallet_kgs}/{selectedRow}/{selectedColumn}/{material}/{grower}/{sample}', ['as'=>'cleanresuls.addBatch','uses'=>'CleanBulkingController@addBatch']);
		...
		Route::get('/bulking/getBulkDetails/{process}/{bulking_season}', ['as'=>'bulking.getBulkDetails','uses'=>'CleanBulkingController@getBulkDetails']); 
		Route::get('/bulking/printResults/{ref_no}', ['as'=>'bulking.printResults','uses'=>'CleanBulkingController@printResults']); 
		...
		Route::get('/editparchment/unconfirm/{grn}', ['uses'=>'ParchmentController@unconfirm']);

		Route::get('/editclean', 'CleanController@getGrid');
		Route::get('/editcleanedit', 'CleanController@Edit');
		Route::patch('/editcleanedit', 'CleanController@Edit');
		Route::delete('/editcleanedit', 'CleanController@Edit');

		Route::get('/editcleanbatch', 'CleanController@getBatchGrid');
		...
		Route::delete('/editgroweredit', 'GrowerController@BEdit');
