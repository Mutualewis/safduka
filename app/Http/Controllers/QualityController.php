...
class QualityController extends Controller {
    ...
    public function qualityForm (Request $request){
    	...
    	return View::make('cataloguequalitydetails', compact('id', 'Season', 'country', 'CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'largest', 'greensize', 'greencolor', 'greendefects', 'processing', 'cupscore', 'rawscore', 'screens', 'seller', 'sale', 'sale_lots', 'serve', 'timeout'));
    ...
    public function addQualityDetails (Request $request){
  		...
  		if (NULL !== Input::get('searchButton')) {
	    	...
	    	$greendefects = quality_parameters::where('qg_id', '3')->get()->orderBy('qp_parameter');
    	...
    	return View::make('cataloguequalitydetails', compact('id', 'Season', 'country', 'CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'largest', 'greensize', 'greencolor', 'greendefects', 'processing', 'cupscore', 'rawscore', 'screens', 'seller', 'sale', 'sale_lots', 'sale_season', 'cid', 'sale_id', 'seller_id'));
    ...
    public function qualityListForm (Request $request){
    	...
    	return View::make('cataloguequalitydetailslist', compact('id', 'Season', 'country', 'CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'largest', 'greensize', 'greencolor', 'greendefects', 'processing', 'cupscore', 'rawscore', 'screens'));
					...
					if($request->has('qualityTy')){
						...
						if($request->has('seller')  && $sale_lots->first() != NULL){
							...
							if ($saleselected->sl_catalogue_confirmedby == NULL){
								$request->session()->flash('alert-warning',  'Catalogue for Sale '.$saleselected->sl_no.' has not been confirmed yet. Please confirm to continue.');
								return View::make('cataloguequalitydetailslist', compact('id', 
									'Season', 'country', 'cid', 'csn_season', 'sale','CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'seller', 'greensize', 'greencolor', 'greendefects', 'processing', 'cdetails', 'greencomments', 'screens', 'cupscore', 'rawscore', 'qdetails', 'sale_lots', 'slr', 'QualityType', 'qtype', 'StockView'));	
						 	} else if ($saleselected->sl_quality_confirmedby != NULL){
								$request->session()->flash('alert-warning',  'Catalogue Quality for Sale '.$saleselected->sl_no.' has already been confirmed by '.$saleselected->sl_quality_confirmedby.'.');
								return View::make('cataloguequalitydetailslist', compact('id', 
									'Season', 'country', 'cid', 'csn_season', 'sale','CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'seller', 'greensize', 'greencolor', 'greendefects', 'processing', 'cdetails', 'greencomments', 'screens', 'cupscore', 'rawscore', 'qdetails', 'QualityType', 'qtype', 'StockView'));	
						 	} else {
								if ($cdetails !== NULL) {
									$request->session()->flash('alert-success', 'Sale Lot Found!!');
									...
									return View::make('cataloguequalitydetailslist', compact('id', 
										'Season', 'country', 'cid', 'csn_season', 'sale','CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'seller', 'sale_lots', 'saleid', 'greensize', 'greencolor', 'greendefects', 'processing', 'greencomments', 'screens', 'cupscore', 'rawscore', 'qdetails', 'slr', 'QualityType', 'qtype', 'StockView'));	
								}
							}	
						...
						return View::make('cataloguequalitydetailslist', compact('id', 
							'Season', 'country', 'cid', 'csn_season', 'sale','CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'seller', 'saleid', 'greensize', 'greencolor', 'greendefects', 'processing', 'greencomments', 'screens', 'cupscore', 'rawscore', 'qdetails', 'slr', 'QualityType', 'qtype', 'StockView'));					
					}
				} else {
					$request->session()->flash('alert-success', 'Sale Lot Found!!');
					return View::make('cataloguequalitydetailslist', compact('id', 
