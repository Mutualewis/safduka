...
class PurchasePerSellerController extends Controller {

    public function purchasePerSellerForm (Request $request){
        $id = null;
        $Season = Season::all(['id', 'csn_season']);
        $country = country::all(['id', 'ctr_name', 'ctr_initial']);
        $sale = null;

        return View::make('purchaseperseller', compact('id', 'Season', 'country', 'sale'));

    }

    public function purchasePerSeller (Request $request){
        $id = null;
        $Season = Season::all(['id', 'csn_season']);
        $country = country::all(['id', 'ctr_name', 'ctr_initial']);
        ...
        if (null !== Input::get('viewpdf')) {
           ...
           return $this->displayExcelReport($request);
            ...
            return View::make('purchaseperseller', compact('id', 'Season', 'country', 'sale', 'cid', 'csn_season', 'saleid'));  
        }
    ...
    public function displayPDFReport ($request){
        ...
        $columns = [
            ...
            'Outturn/Marks' => function($result) {
                return $result->outturn.$result->mark;
            },
        ...
        */
        return PdfReport::of($title, $meta, $queryBuilder, $columns)
                        ...
                        ->editColumns(['Kilos', 'Bags', 'Pkts', 'Price', 'Value', 'Hedge', 'Diff', 'Bric Ctr'], [
                            'class' => 'right'
                        ])
                        ->showTotal([
                            'Kilos' => 'point',
                        ...
                        // ->download('purchaseperseller_Season_'.$selectedSeason.'_Sale_'.$selectedSale);
