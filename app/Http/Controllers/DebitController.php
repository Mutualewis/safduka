...
class DebitController extends Controller {
    ...
    public function accountsDebitForm (Request $request){
    	$id = NULL;
    	...
    	return View::make('accountsdebit', compact('id', 'Season', 'country', 'CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'largest', 'greensize', 'greencolor', 'greendefects', 'processing', 'cupscore', 'rawscore', 'screens'));

    }

    public function accountsDebit (Request $request){
