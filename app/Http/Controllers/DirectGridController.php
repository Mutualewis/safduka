...
class DirectGridController extends Controller {
    ...
    public function catalogueGrid (Request $request){
        ...
        $grid = new Grid(
            (new GridConfig)
                ->setDataProvider(
                    new EloquentDataProvider(direct_sale::query())
                )
    	...
    	return View::make('dtreport', compact('id','grid', 'text', 'Season', 'country', 'CoffeeGrade', 'Warehouse', 'Mill', 'Certification'));
    	...
    	if($request->has('country')){
    		if($request->has('sale_season') & Input::get('sale_season') !== "Sale Season" ){
    				...
    				if($request->has('sale')){
						...
						$query = direct_sale::where('slid','=',$saleid);
						...
						return View::make('dtreport', compact('id', 'grid', 'text',
						...
						$cid = Input::get('country');
						$csn_season = Input::get('sale_season');
						return View::make('dtreport', compact('id', 
							'Season', 'country', 'cid', 'csn_season', 'sale','CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'seller', 'sale_lots', 'saleid'));					
    				}
					...
					$cid = Input::get('country');
					$csn_season = Input::get('sale_season');
					return View::make('dtreport', compact('id', 'Season', 'country', 'cid', 'csn_season', 'sale','CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'seller'));	
			}
    	} else {

			return redirect('dtreport')
                        ->withErrors("Please select a valid Country!!")->withInput();
		}

    	return View::make('dtreport', compact('id', 'Season', 'country', 'Warehouse', 'Mill', 'Certification', 'seller'));		
	}
    ...
    public function catalogueQualityGrid (Request $request){
        ...
        return View::make('dtquality', compact('id','grid', 'text', 'Season', 'country', 'CoffeeGrade', 'Warehouse', 'Mill', 'Certification'));
        ...
        if($request->has('country')){
            if($request->has('sale_season') & Input::get('sale_season') !== "Sale Season" ){
                    ...
                    if($request->has('sale')){
                        ...
                        return View::make('dtquality', compact('id', 'grid', 'text',
                            'Season', 'country', 'cid', 'csn_season', 'sale','CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'seller', 'sale_lots', 'saleid'));    
                    } else {
                        $sale = Sale::where('ctr_id', '=', Input::get('country'))->where('csn_id',  Input::get('sale_season'))->get();
                        $request->session()->flash('alert-success', 'Sale found!!');
                    ...
                    $cid = Input::get('country');
                    $csn_season = Input::get('sale_season');
                    return View::make('dtquality', compact('id', 'Season', 'country', 'cid', 'csn_season', 'sale','CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'seller'));   
            }
        } else {

            return redirect('dtquality')
                        ->withErrors("Please select a valid Country!!")->withInput();
        }

        return View::make('dtquality', compact('id', 'Season', 'country', 'Warehouse', 'Mill', 'Certification', 'seller'));      
    }
}
