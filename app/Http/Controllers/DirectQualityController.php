...
class DirectQualityController extends Controller {
    ...
    public function qualityForm (Request $request){
    	...
    	return View::make('directqualitydetails', compact('id', 'Season', 'country', 'CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'largest', 'greensize', 'greencolor', 'greendefects', 'processing', 'cupscore', 'rawscore', 'screens', 'seller', 'sale', 'sale_lots', 'serve', 'timeout'));
    ...
    public function addQualityDetails (Request $request){
    	...
    	return View::make('directqualitydetails', compact('id', 'Season', 'country', 'CoffeeGrade', 'Warehouse', 'Mill', 'Certification', 'largest', 'greensize', 'greencolor', 'greendefects', 'processing', 'cupscore', 'rawscore', 'screens', 'seller', 'sale', 'sale_lots', 'sale_season', 'cid', 'sale_id', 'seller_id'));
    ...
    public function getLots($countryID, $saleSeason, $saleNumber, $seller, $cfd_id, $direction, $lot_number, $outt_number, $coffee_grade)
    {
    	...
    	if ($direction == 'null') {
	        ...
	        $sale_lots= DB::table('sale_sl AS sl')
	            ...
	            ->where('cfd.cfd_outturn', $outt_number)
	            ->where('cfd.cgrad_id', $coffee_grade)
	            ->groupBy('cfd.id')
	            ->first();
