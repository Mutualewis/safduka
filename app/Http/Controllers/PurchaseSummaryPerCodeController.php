...
class PurchaseSummaryPerCodeController extends Controller {

    public function purchaseSummaryPerCodeForm (Request $request){
        $id = null;
        ...
        return View::make('purchasesummarypercode', compact('id', 'Season', 'country', 'sale', 'months'));

    }

    public function purchaseSummaryPerCode (Request $request){
        $id = null;
        $Season = Season::all(['id', 'csn_season']);
        $country = country::all(['id', 'ctr_name', 'ctr_initial']);
        ...
        if (null !== Input::get('viewpdf')) {
           ...
           return $this->displayExcelReport($request);
            ...
            return View::make('purchasesummarypercode', compact('id', 'Season', 'country', 'sale', 'cid', 'csn_season', 'saleid', 'months', 'mthID'));  
        }
    ...
    public function displayPDFReport ($request){
        ...
        */
        return PdfReport::of($title, $meta, $queryBuilder, $columns)
                        ...
                        // ->download('purchasesummarypercode_Season_'.$selectedSeason.'_Sale_'.$selectedSale);
    ...
    public function displayExcelReport ($request){
        ...
        */
        return ExcelReport::of($title, $meta, $queryBuilder, $columns)
                        ...
                        ->groupBy('QualityCode')
                        // ->stream(); // or download('filename here..') to download pdf
                        ->download('purchasesummarypercode_Season_'.$selectedSeason.'_Month_'.$selectedMonth);
