...
define('PHPGRID_DB_USERNAME', 'ngeatpmfkdb');     // database user name
define('PHPGRID_DB_PASSWORD', 'Athi12is!'); // database password
define('PHPGRID_DB_NAME', 'ngea_db'); // database name
