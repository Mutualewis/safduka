...
@section('page_heading','Provisional Purpose Settings')
...
?>
	...
	<div class="col-md-6 col-md-offset-0">
	        ...
	        <form role="form" method="POST" action="/settingsprovisionalpurpose">
	        	...
	        	<div class="row">
		            ...
		            <div class="form-group col-md-6">
		            	<label>Provisional Purpose</label>
		                <input class="form-control" placeholder="Purpose" name="purpose" value="{{ old('purpose') }}">
		            </div>		            
	...
	<div class="col-md-6 col-md-offset-0" style="margin-left: -200px;">
		<form role="form" method="POST" action="settingsprovisionalpurpose">
	        	<input type="hidden" name="_token" value="{{ csrf_token() }}">		
				<h3>Provisional Purpose(S)</h3>
				<table class="table table-striped" id="provisional-purpose-table">
				<thead>
				  <tr>
					<th>
						No.
...
@push('scripts')
<script>
var path= "{{URL::to('settingsprovisionalpurpose')}}";
$(document).ready(function (){  
	...
	function checkDeletable(e, val){
	  ...
	  var purposeID=val.id;
	

	  var url = '{{ route('settingsprovisionalpurpose.provisional_purpose_delete',['id'=>":id"]) }}';
	  url = url.replace(':id', purposeID);
