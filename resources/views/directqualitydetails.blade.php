	        	...
	        	<div class="row">
	        		...
	        		<div class="form-group col-md-4">
	                    <div class="input-group custom-search-form">
	                        <input type="text" class="form-control" id="outt_number" name="outt_number" style="text-transform:uppercase; " placeholder="Search Outturn..."  value="{{ old('outt_number'). $outt_number }}"></input>
...
<script type="text/javascript">
	...
	function fetch_url(cfd_id, direction, lot_number, outt_number, coffee_grade) {
		...
		var url = '{{ route('directqualitydetails.getLots',['country_id'=>":id",'sale_season'=>":slssn",'sale_number'=>":slno",'seller'=>":slr",'cfd_id'=>":cfd_id",'direction'=>":direction",'lot_number'=>":lot_number",'outt_number'=>":outt_number",'coffee_grade'=>":coffee_grade"]) }}';
	...
	$(document).ready(function() {	
		...
		$('#button_next_green').on('click', function(){
			...
			var url = '{{ route('directqualitydetails.saveGreen',['cfd_id'=>":id",'dnt'=>":dnt",'greensize'=>":greensize",'greencolor'=>":greencolor",'greendefects'=>":greendefects",'process_type'=>":process_type",'process_loss'=>":process_loss",'raw'=>":raw", 'comments'=>":comments"]) }}';
		...
		$('#button_next_screen').on('click', function(){
			...
			var url = '{{ route('directqualitydetails.saveScreen',['cfd_id'=>":id",'screen_size'=>":screen_size",'screen'=>":screen"]) }}';
		...
		$('#button_next_cup').on('click', function(){
			...
			var url = '{{ route('directqualitydetails.saveCup',['cfd_id'=>":id",'cup'=>":cup",'dnt_cp'=>":dnt_cp",'acidity'=>":acidity",'body'=>":body",'flavour'=>":flavour",'comments_cp'=>":comments_cp"]) }}';
