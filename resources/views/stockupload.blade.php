...
@section('page_heading','Upload Auction Details')
@section('section')
...
<a href="{{ URL::to('downloadExcelAuction/xls') }}"><button class="btn btn-success">Download Template xls</button></a>
...
<div class="row">
	<div class="col-md-6 col-md-offset-3" >
			...
			<div class="container">
		        <form action="{{ URL::to('stockupload') }}" class="form-horizontal" method="post" enctype="multipart/form-data" id="stockuploadform">
