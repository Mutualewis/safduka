...
@section('page_heading','Trading Months Settings')
...
<div class="col-md-14 col-md-offset-1">
	...
	<div class="col-md-6 col-md-offset-0">
	        ...
	        <form role="form" method="POST" action="/settingstradingmonths">
	        	...
	        	<div class="row">
		            ...
		            <div class="form-group col-md-6">
		                ...
		                <input class="form-control" placeholder="Sale Status" name="month" value="{{ old('month') }}" required>
		            </div>		            
	...
	<div class="col-md-6 col-md-offset-0" style="margin-left: -200px;">
		<form role="form" method="POST" action="settingstradingmonths">
				...
				<table class="table table-striped" id="trm-table">
				<thead>
				  <tr>
					<th>
						No.
					...
					<?php
						...
						if (isset($months) && count($months) > 0) {
							...
							foreach ($months as $value) {
								...
								echo "<tr>";
									echo "<td>".$count."</td>";
									echo "<td>".$value->trm_month."</td>";
									echo "<td>".$value->trm_code."</td>";	
...
@push('scripts')
<script>
var path= "{{URL::to('settingstradingmonths')}}";
$(document).ready(function (){  
	...
	function checkDeletable(e, val){
	  ...
	  var url = '{{ route('settingstradingmonths.trading_month_delete',['id'=>":id"]) }}';
	  url = url.replace(':id', monthID);
