...
@section('page_heading','Assign Direct Purchase Contracts')
@section('section')
...
?>
    <div class="col-md-5">
	        <form role="form" method="POST" action="briccontractsdirect" id="briccontractsdirectform">
	        	...
	        	<div class="row">
		            ...
		            <div class="form-group col-md-6">
		                <label>Grower</label>
		                <select class="form-control" name="coffee_grower" onchange="this.form.submit()">
		                	<option></option> 
...
console.log(autosubmit)
	$(document).ready(function (){ 
		if(autosubmit){
			$( "#briccontractsdirectform" ).submit();
		}
	})
</script>
@endpush