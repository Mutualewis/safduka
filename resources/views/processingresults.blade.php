...
<?php 
    ...
    $teamsstring=json_encode($teams->toJson());
	        ...
	        <form role="form" method="POST" action="/processingresults" id="processingresultsform">
	        	...
	        	<div class="row">
		            ...
		            <div class="form-group col-md-4">
		                ...
		                <select class="form-control" name="process_type" id="process_type" onchange="this.form.submit()">
		                	<option></option> 
...
var teams = <?php echo $teamsstring; ?>;
