...
document.getElementById('ml').value = null;
	...
	$(document).ready(function() {	
		...
		function saveGreen(st_id , direction){
			...
			var url = '{{ route('cataloguequalitydetails.saveGreen',['st_id'=>":st_id",'dnt'=>":dnt",'greensize'=>":greensize",'greencolor'=>":greencolor",'greendefects'=>":greendefects",'raw'=>":raw",'comments'=>":comments"]) }}';
