...
@section('page_heading','Pending Provisional Instructions')
@section('section')
...
?>
    <div class="col-md-12">
	        <form id="stocksForm" role="form" method="POST" action="processingprovisionalview">
...
<script>
	...
	var url = '{{ route('processingprovisionalview.getprocessview') }}';

    var table = $('#stocks-table').DataTable({
		dom: 'Bfrtip',      	
   		type: 'POST',
   		url: 'processingprovisionalview',
        processing: true,
        deferRender: true,
     	ajax: url,
     	autoWidth: true,
        ...
        columnDefs: [
			...
			{targets: 8, 
				...
				'render': function (data, type, full, meta, row){
					return '<a href="/amendprovisional/' + $('<div/>').text(data).html() +  ' ">Amend</a>';
			}},
			{targets: 9, 
				'searchable':true,
				'orderable': true,
				'render': function (data, type, full, meta, row){
					return '<a href="/clear/' + $('<div/>').text(data).html() +  ' ">Clear</a>';
			}},
        ...
        columns: [
            ...
            { data: 'prp_name', name: 'prp_name'},
            { data: 'pbk_comments', name: 'pbk_comments'},
