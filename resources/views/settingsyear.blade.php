...
@section('page_heading','Year Settings')
...
?>
	...
	<div class="col-md-6 col-md-offset-0">
	        ...
	        <form role="form" method="POST" action="/settingsyears">
	        	...
	        	<div class="row">
		            ...
		            <div class="form-group col-md-6">
		            	<label>Year</label>
		                <input class="form-control" placeholder="year" name="year" value="{{ old('year') }}" required>
		            </div>		            
	        	...
	        	<div class="row">
		            ...
		            <div class="form-group col-md-6">
		            	<label>Number</label>
		                <input class="form-control" placeholder="number" name="number" value="{{ old('number') }}">
		            </div>		            
					...
					<?php
						...
						if (isset($years) && count($years) > 0) {
							...
							foreach ($years as $value) {
								...
								echo "<tr>";
									echo "<td>".$count."</td>";
									echo "<td>".$value->yr_name."</td>";
									echo "<td>".$value->yr_number."</td>";
...
$(document).ready(function (){  
	...
	function checkDeletable(e, val){
	  ...
	  var url = '{{ route('settingsyears.year_delete',['id'=>":id"]) }}';
	  url = url.replace(':id', yearID);
