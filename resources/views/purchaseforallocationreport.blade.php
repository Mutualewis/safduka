...
@section('page_heading','Purchase For Allocation')
@section('section')
...
<div class="row">
	<div class="col-md-6 col-md-offset-3" >
			...
			<div class="container">
		        <form action="{{ URL::to('purchaseforallocationreport') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
