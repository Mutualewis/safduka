...
@section('page_heading','Upload Catalogue')
@section('section')
...
?>
<h4><strong>
	NB:The catalogue should be uploaded in the correct format. Use the template provided as a guideline.
</strong></h4>		

<a href="{{ URL::to('downloadExcelCatalogue/xls') }}"><button class="btn btn-success">Download Template xls</button></a>
...
<div class="row">
	<div class="col-md-6 col-md-offset-3" >
			...
			<div class="container">
		        <form action="{{ URL::to('catalogueupload') }}" class="form-horizontal" method="post" enctype="multipart/form-data" id="catalogueuploadform">
