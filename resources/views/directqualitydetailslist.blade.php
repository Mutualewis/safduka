...
?>
    <div class="col-md-12">
	        <form role="form" method="POST" action="directqualitydetailslist" id="directqualitydetailslistform">
...
$(document).ready(function (){  
	var url = '{{ route('directqualitydetailslist.getsalelots',['countryID'=>":id",'saleSeason'=>":slssn",'saleNumber'=>":slno",'seller'=>":slr"]) }}';
...
@endpush				
				...
				<div class="row">
		            <div class="form-group col-md-12">
		           		<button type="submit" name="confirmquality" class="btn btn-lg btn-danger btn-block">Confirm Quality Information</button>
		            </div>
		        </div>
	        </form>
	</div>
...
var autosubmit = <?php echo json_encode($autosubmit); ?>;
	$(document).ready(function (){ 
		if(autosubmit){
			$( "#directqualitydetailslistform" ).submit();
		}
	})
</script>
@endpush