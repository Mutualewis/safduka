...
@section('page_heading','Confirm Payment')
@section('section')
...
?>
    <div class="col-md-10">
	        <form role="form" method="POST" action="confirmpayment"
		        		...
		        		?>
							<div class="row">
					            <div class="form-group col-md-14">
					           		<button type="submit" name="confirmpayment" class="btn btn-lg btn-success btn-block">Confirm Payment</button>
					            </div>
