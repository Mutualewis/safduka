...
@section('page_heading','Cup Settings')
...
?>
	...
	<div class="col-md-6 col-md-offset-0">
	        ...
	        <form role="form" method="POST" action="/settingscup">
		        ...
		        <div class="row">
		            ...
		            <div class="form-group col-md-6">
		                ...
		                <input class="form-control" placeholder="Cup score" name="cupscore" value="{{ old('cupscore') }}" required>
		            </div>		            
	        	...
	        	<div class="row">
		            ...
		            <div class="form-group col-md-6">
		            	<label>Cup qualification</label>
		                <input class="form-control" placeholder="cup qualification" name="qualification" value="{{ old('qualification') }}" required>
		            </div>		            
	...
	<div class="col-md-6 col-md-offset-0" style="margin-left: -200px;">
		<form role="form" method="POST" action="settingsraw">
	        	<input type="hidden" name="_token" value="{{ csrf_token() }}">		
				<h3>Cup Score</h3>
				<table class="table table-striped" id="cup-table">
				<thead>
				  <tr>
					<th>
						No.
						...
						if (isset($cupscore) && count($cupscore) > 0) {
							foreach ($cupscore as $value) {
								...
								echo "<tr>";
									...
									echo "<td>".$value->cp_qualification."</td>";
...
$(document).ready(function (){  
	...
	function checkDeletable(e, val){
	 ...
	 var url = '{{ route('settingscup.cup_delete',['id'=>":id"]) }}';
	 url = url.replace(':id', cupID);
