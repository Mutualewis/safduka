...
?>
    <div class="col-md-4">
	        <form role="form" method="POST" action="stockindividual">
	        	...
	        	<h3  data-toggle="collapse" data-target="#green">Auction Details</h3> 
...
<!-- 			 	<div class="row">
		   ...
		   <!--          <div class="row">
				...
				<div class="row">
		            <div class="form-group col-md-12">
		           		<button type="submit" name="submitlot" class="btn btn-lg btn-success btn-block">Add/Update Lot Details</button>
		            </div>
					...
					<?php
						...
						if (isset($sale_lots) && count($sale_lots) > 0) {
							...
							foreach ($sale_lots->all() as $sale_lots) {
					    		...
					    		$total_value = ($sale_lots->weight)/50 * ($sale_lots->auc_price);
								...
								if ($sale_lots->dnt > 0 ) {
									...
									echo "<td>".$sale_lots->auc_price. "</td>";
