...
@section('page_heading','Parchment Arrival Quality')
@section('section')
<div class="col-sm-12">
...
?>
	        <form role="form" method="POST" action="qualityparchment">
	        	...
	        	<div class="row">
	        		...
	        		<div class="form-group col-md-3">
	                    <div class="input-group custom-search-form">
	                        <input type="text" class="form-control" name="outt_number"  style="text-transform:uppercase" placeholder="Search/Enter Outturn..."  value="{{ old('outt_number'). $outt_number }}"></input>
		            ...
		            <?php echo "<strong>".$pty_name.", &nbsp&nbsp&nbsp&nbsp".$outt_gross_weight." KGS </strong>"; ?>
